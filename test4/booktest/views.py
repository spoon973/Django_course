...
# /temp_tages
def temp_tages(request):
    '''模板标签'''
    # 1.查找所有图书的信息
    books = BookInfo.objects.all()
    # 2.返回页面
    return render(request, 'booktest/temp_tage.html', {'books':books})
